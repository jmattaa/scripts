...
'''
hopefully qvickbuild will be able to just give output of commands in the future
and render this function redunant
'''


def run_qvickbuild_cmd(cmd_name):
...
src_files = run_qvickbuild_cmd("echocfiles")
if src_files:
    src_files = src_files[0].split()
else:
    src_files = []

compile_flags_lines = run_qvickbuild_cmd("echocompileflags")
